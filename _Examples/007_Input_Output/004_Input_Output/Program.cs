...
namespace _004_Input_Output
{
    class Program
    {
        static void Main()
        {
            ...
            DirectoryInfo directory = new DirectoryInfo(@"E:\ITEA Курс по С#\New_Version\ITEA - Продвинутый курс по С#\007_Ввод-вывод\Testing");
...

            {
                ...
                Directory.Delete(@"E:\ITEA Курс по С#\New_Version\ITEA - Продвинутый курс по С#\007_Ввод-вывод\Testing\SUBDIR");
                
                // Удаляет каталог по заданному пути
                // Второй параметр определяет, будут ли удалены также и все вложенные подкаталоги. 
                Directory.Delete(@"E:\ITEA Курс по С#\New_Version\ITEA - Продвинутый курс по С#\007_Ввод-вывод\Testing\MyDir", true);
