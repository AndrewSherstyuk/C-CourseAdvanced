...
namespace _021_StringReader
{
    class Program
    {
        static void Main()
        {
            string stringRow = "Hello all!" + Environment.NewLine + "This is a multi-line text string." + Environment.NewLine + Environment.NewLine + Environment.NewLine+ Environment.NewLine+"v";
